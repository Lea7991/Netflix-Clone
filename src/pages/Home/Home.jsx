    ...
    <div className='home'>
      ...
      <div className="hero">
        ...
        <div className="hero__caption">
          ...
          <p>Discovering his ties to a secret ancient order, a young man living in a modern Istanbul embarks on a quest to save the city from an immortal enemy.</p>
      ...
      <div className="more__cards">
        ...
        <TitleCards title={"Only on Netflex"} category={"popular"}/>
